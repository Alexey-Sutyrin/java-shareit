...
public class ItemRequestServiceIntegrationTest {
    ...
    public void getUserRequestsWithAnswersTest() {
        ...
        List<ItemRequestOutDto> dtos = itemRequestService.getUserRequestsWithAnswers(requesterId);
    ...
    public void getRequestsOfOthersTest() {
        ...
        List<ItemRequestOutDto> dtos = itemRequestService.getRequestsOfOthers(userId, 0, 10);
    ...
    public void getItemRequestTest() {
        ...
        ItemRequestOutDto itemRequestOutDto = itemRequestService.getItemRequest(1L, requestId);
